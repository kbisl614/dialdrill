...
import AchievementBadges, { calculateAchievements, type Achievement } from './AchievementBadges';
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <p className="mt-2 text-4xl font-bold text-white tabular-nums">{stats.totalCalls}</p>
        ...
        >
          ...
          <p className="mt-2 text-4xl font-bold text-white tabular-nums">{stats.avgOverallScore.toFixed(1)}%</p>
          {stats.improvementPercentage > 0 && (
            <p className="mt-1 text-xs text-green-400 flex items-center gap-1">
              <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
              </svg>
              +{stats.improvementPercentage.toFixed(1)}% improvement
            </p>
          )}
        </motion.div>
        ...
        >
          ...
          <p className="mt-2 text-4xl font-bold text-white tabular-nums">{stats.bestScore.toFixed(1)}%</p>
          {stats.bestScore >= 90 && (
      ...
      >
        ...
        <SkillRadarChart categoryScores={stats.avgCategoryScores} maxScore={10} />
