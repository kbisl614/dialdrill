        ...
        <div className="grid grid-cols-2 gap-1">
          ...
          <button
            ...
            className={`group relative rounded-lg p-4 transition-all duration-300 ${
              selectionMode === 'random'
                ? 'bg-gradient-to-br from-[#00d9ff]/20 to-[#00ffea]/10 shadow-[inset_0_0_20px_rgba(0,217,255,0.1)]'
                : 'hover:bg-white/[0.03]'
            }`}
          >
            <div className="flex flex-col items-center gap-2 text-center">
              <div className={`flex h-12 w-12 items-center justify-center rounded-xl text-2xl transition-all ${
                selectionMode === 'random'
                  ? 'bg-[#00d9ff]/20 scale-110 shadow-[0_0_20px_rgba(0,217,255,0.3)]'
              ...
              <div>
                <p className={`text-sm font-bold transition-colors ${
                  selectionMode === 'random' ? 'text-[#00d9ff]' : 'text-white'
                }`}>
                  Surprise Me
                </p>
                <p className="text-[10px] text-[#64748b] mt-0.5">Random • Best for training</p>
              </div>
            </div>
            {selectionMode === 'random' && (
              <div className="absolute top-2 right-2 flex h-5 w-5 items-center justify-center rounded-full bg-[#00d9ff] shadow-[0_0_15px_rgba(0,217,255,0.6)]">
          ...
          >
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <div>
                <p className={`text-sm font-bold transition-colors ${
                  selectionMode === 'select' ? 'text-[#00d9ff]' : 'text-white'
                }`}>
        ...
        <div className="animate-fadeIn">
          ...
          >
            <div className="flex items-center gap-2">
              <svg className={`w-4 h-4 text-[#00d9ff] transition-transform ${showPersonalities ? 'rotate-90' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {allPersonalities.map((personality) => {
                ...
                return (
                  ...
                  >
                    ...
                    {personality.isBoss && (
                      <span className="mt-1.5 inline-block rounded-full bg-[#a855f7]/20 px-2 py-0.5 text-[9px] font-bold text-[#d8b4fe]">
                        BOSS
                      </span>
                    )}
                    {isSelected && (
