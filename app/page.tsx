    ...
    <section ref={ref} id="how-it-works" className="section-fade-top relative border-t border-white/5 py-24 lg:py-32">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#a855f7] to-[#9333ea] text-2xl font-bold text-white ring-4 ring-[#a855f7]/20 shadow-[0_0_30px_rgba(168,85,247,0.4)]">
              1
            </div>
