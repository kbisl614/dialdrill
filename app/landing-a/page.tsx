...
export default function LandingA() {
  ...
  const features: Feature[] = [
    {
      title: 'Build confidence before high-stakes calls',
      description: 'Run the conversation five times before you dial the real decision-maker. No more winging it.',
      stats: [
        { label: 'Practice Scenarios', value: '40+' },
        { label: 'Real Objections', value: 'Yes' },
      ],
    },
    {
      title: 'Get feedback you can actually use',
      description: 'Not vague "be more confident" advice. Specific notes on what to say differently, where you lost them, and how to recover.',
      stats: [
        { label: 'Feedback Speed', value: 'Instant' },
        { label: 'Coaching Areas', value: '5' },
      ],
    },
    {
      title: 'Track your improvement over time',
      description: 'Scores, streaks, and badges show your progress. Watch yourself level up from nervous caller to confident closer.',
      stats: [
        { label: 'Progress Tracking', value: 'Built-in' },
        { label: 'Skill Badges', value: 'Unlockable' },
      ],
    },
  ];
...
// Hero Section - Variant A Copy (Sales Reps, SDRs, Teams)
      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-[var(--color-cyan-bright)]/30 bg-[var(--color-cyan-bright)]/10 px-4 py-1.5 text-sm text-[var(--color-text-secondary)] backdrop-blur-sm">
            ...
            <span className="font-medium text-white">Sales Training</span>
            <span className="text-[var(--color-text-muted)]">•</span>
            <span className="text-[var(--color-text-secondary)]">AI-Powered Practice</span>
          </div>
        </motion.div>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              <BlurText
                text="Practice cold calls"
                delay={100}
                animateBy="words"
                className="text-white"
              />{' '}
              <BlurText
                text="without the cold sweats."
                delay={150}
                animateBy="words"
            ...
            >
              DialDrill lets you rehearse real sales conversations with AI prospects — then shows you exactly how to improve.
            </motion.p>
            {/* Supporting Bullets */}
            <motion.ul
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              <li className="flex items-center gap-3 text-[var(--color-text-secondary)]">
                ...
                Talk to AI personas that push back like real buyers
              </li>
              <li className="flex items-center gap-3 text-[var(--color-text-secondary)]">
                <span className="h-1.5 w-1.5 rounded-full bg-[var(--color-cyan-bright)]"></span>
                Get instant coaching on your tone, pacing, and objection handling
              </li>
              <li className="flex items-center gap-3 text-[var(--color-text-secondary)]">
                <span className="h-1.5 w-1.5 rounded-full bg-[var(--color-cyan-bright)]"></span>
                Track your progress with scores, streaks, and skill badges
              </li>
            </motion.ul>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
...
function MetricsStrip() {
  ...
  const metrics: MetricCard[] = [
    { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', value: '40+', label: 'Practice scenarios to choose from', color: '#fbbf24' },
    { icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', value: 'Faster', label: 'Get better with every call', color: '#fbbf24' },
    { icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', value: 'Instant', label: 'Feedback after every call', color: '#fbbf24' },
    { icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', value: 'Unlimited', label: 'Recordings you can replay', color: '#fbbf24' },
  ];
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        ...
        >
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            Everything you need to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-cyan-bright)] to-[#00ffea]">get better</span>
          </h2>
          <p className="mt-3 text-base text-[var(--color-text-secondary)]">
            Make your mistakes here, not on real prospects.
          </p>
        </motion.div>
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        ...
        >
          <h2 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Three steps to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-cyan-bright)] to-[#00ffea]">sharper calls</span>
          </h2>
          <p className="mt-5 text-xl text-[var(--color-text-secondary)] max-w-3xl mx-auto">
            Practice makes permanent. Build the habits that close deals.
          </p>
        </motion.div>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex-1 pt-2">
              <h3 className="text-2xl font-bold text-white mb-3">Pick your scenario</h3>
              <p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">
                Choose from common cold call situations — gatekeepers, skeptical buyers, budget objections, or &quot;send me an email&quot; brushoffs.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex-1 pt-2">
              <h3 className="text-2xl font-bold text-white mb-3">Make the call</h3>
              <p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">
                Dial into an AI prospect that responds in real-time. Handle objections. Push for the meeting. The conversation flows naturally.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex-1 pt-2">
              <h3 className="text-2xl font-bold text-white mb-3">Get your coaching</h3>
              <p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">
                After each call, see exactly where you nailed it and where you lost them. Actionable feedback on pacing, tone, and technique.
              </p>
            </div>
          </motion.div>
        </div>
  ...
  const plans = [
    {
      ...
      features: ['5 AI practice calls', 'Coaching feedback after each call', 'Full access to all scenarios', 'Available twice per account'],
    ...
    },
    {
      ...
      price: '$11.99',
      cadence: '/month',
      highlight: 'Best for serious practice',
      features: ['20 minutes per month', 'All coaching features', 'Progress tracking with belts, badges, and streaks', 'Custom AI personalities (coming soon)'],
      cta: 'Get Started',
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        ...
        >
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl">
            Start for <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-cyan-bright)] to-[#00ffea]">$5</span>
          </h2>
...
function ProofSection() {
  ...
  const quotes = [
    {
      quote: "My first month of cold calling was brutal. I wish I could've practiced somewhere safe first.",
      context: "Someone new to sales",
    },
    {
      quote: "Role-playing with my manager feels awkward. I can't get real practice in.",
      context: "Looking for better ways to train",
    },
    {
      quote: "I'd pay good money for a way to practice without embarrassing myself.",
      context: "On call anxiety",
    },
  ];
  ...
  return (
    <section ref={ref} id="proof" className="relative py-16">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        ...
        >
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            You&apos;re <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-cyan-bright)] to-[#00ffea]">not alone</span>
          </h2>
          <p className="mt-3 text-base text-[var(--color-text-secondary)]">
            A lot of people struggle with cold calls. Here&apos;s what they say online.
          </p>
        </motion.div>
        ...
        >
          DialDrill exists because we heard you.
        </motion.p>
      </div>
    </section>
  );
...
function ObjectionsSection() {
  ...
  const objections = [
    {
      question: "Will talking to an AI actually help with real calls?",
      answer: "Yes. The AI responds unpredictably, just like real prospects. You'll face the same objections, the same brushoffs, the same pressure. The skills transfer.",
    },
    {
      question: "I don't have time for this.",
      answer: "One call takes 2-3 minutes. Five calls take less time than your morning coffee. This fits into the gaps in your day.",
    },
    {
      question: "My company already has sales training.",
      answer: "Training teaches concepts. DialDrill builds muscle memory. They work together.",
    },
    {
      question: "What if I'm already experienced?",
      answer: "Even athletes practice fundamentals. DialDrill helps you stay sharp and test new approaches without risk.",
    },
    {
      question: "Is $5 really worth it for a trial?",
      answer: "You get 5 full calls with AI coaching. That's $1 per practice session with personalized feedback. Compare that to one blown deal.",
    },
  ];
  ...
  return (
    <section ref={ref} className="section-fade-top relative border-t border-[var(--color-border-subtle)]/50 py-20 lg:py-28">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        ...
        >
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            Questions <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-cyan-bright)] to-[#00ffea]">we get asked</span>
          </h2>
        </motion.div>
  ...
  const faqs = [
    {
      ...
      answer: 'Calls typically run 2-4 minutes, depending on how the conversation goes.',
    },
    {
      question: 'Can I use this on my phone?',
      answer: 'Yes. DialDrill works on any device with a browser and microphone.',
    },
    {
      question: 'What scenarios are available?',
      answer: 'We cover common cold call situations: gatekeepers, skeptical prospects, budget objections, timing objections, and more. New scenarios added regularly.',
    },
    {
      question: 'Is my call data private?',
      answer: 'Yes. Your calls are used only to generate your coaching feedback. We don\'t share or sell your data.',
    },
    {
      question: 'Can my team use this together?',
      answer: 'Individual accounts only for now. Team plans are on our roadmap.',
    },
    {
  ...
  return (
    <section ref={ref} className="section-fade-top relative border-t border-[var(--color-border-subtle)]/50 py-16 lg:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 text-center lg:px-12">
        ...
        >
          Your next call could go{' '}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-cyan-bright)] to-[#00ffea]">better.</span>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 30 }}
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
        ...
        >
          Practice makes permanent. Start building the habits that close deals.
        </motion.p>
        <motion.div
